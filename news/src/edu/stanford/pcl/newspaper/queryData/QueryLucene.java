package edu.stanford.pcl.newspaper.queryData;
...
public class QueryLucene {
    ...
    public static void Query(JSAPResult JSAPconfig) throws IOException, ParseException, JSAPException, java.text.ParseException {
